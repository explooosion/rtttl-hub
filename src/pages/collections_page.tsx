  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate font-semibold text-gray-900 dark:text-white">{t(nameKey)}</p>
        <p className="line-clamp-2 text-sm text-gray-500 dark:text-gray-400">{t(descriptionKey)}</p>
        {source && (
          <a
            href={source}
            target="_blank"
